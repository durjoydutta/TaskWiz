  ...
  return (
    ...
    >
      <motion.div
        ...
        layout
        className="taskContainer py-3 px-5 sm:px-6 md:px-7 rounded-lg shadow-xl 
                   bg-slate-100 dark:bg-zinc-900/50 shadow-slate-600/20 
                   transition-all hover:shadow-slate-600/50 border-2 
                   border-[#ffb3005f]" 
      >
        <div className="flex gap-3 sm:gap-4 md:gap-5 items-center justify-between select-none">
          ...
          <label
            htmlFor={id}
            className={`ml-2 sm:ml-3 text-sm md:text-base font-medium flex-grow break-all
